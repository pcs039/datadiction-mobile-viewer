      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 space-y-5 no-scrollbar">
        ...
        <div className={`p-4 rounded-2xl border flex items-center justify-between shadow-lg ${
          ...
          {envConfigured || (localUrl && localKey) ? (
            ...
            <AlertCircle className="w-6 h-6 text-amber-450" />
          )}
        </div>
        ...
        <form onSubmit={handleSaveOverrides} className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-4 space-y-4 shadow-xl">
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 text-xs rounded-xl py-2.5 px-3.5 text-white placeholder-slate-600 focus:outline-none focus:border-orange-500 transition-colors"
              />
            </div>
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-orange-600 hover:bg-orange-500 active:scale-95 text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-1.5 shadow-md shadow-orange-600/15"
          >
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=your-anon-key-string`}
        ...
        <div className="bg-slate-900/20 border border-slate-800/40 rounded-2xl p-4 space-y-3">
          ...
          <div className="bg-slate-950 border border-slate-800/60 rounded-xl p-3 text-[10px] font-mono text-emerald-450 overflow-x-auto space-y-1">
